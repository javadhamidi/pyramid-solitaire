...
function board = generateBoard(pyramid, boardSize, stock, drawnCards, discard)
    ...
    for row=1:boardSize+1
        ...
        if row == 1 % add card stock indicator at the end of the first row
            pyramidRow = pyramidRow + "CARDS IN STOCK: " + length(stock);
        elseif row == 2 % add drawn card indicator at the end of the second row
        ...
        elseif row == 4 % add discard pile indicator at the end of the fourth row
